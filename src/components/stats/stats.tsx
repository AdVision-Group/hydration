  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex gap-3.5">
        <p className="font-geist font-normal text-sm leading-4 text-pink">
          {title}
        </p>
        {tagline && (
          <p className="px-1.5 py-1 font-inter uppercase font-semibold text-purple bg-pink leading-3 text-2xs rounded-xl">
            {tagline}
          </p>
        )}
      </div>
      <p className="font-gazpacho font-bold text-[2rem] leading-10 text-pink">
