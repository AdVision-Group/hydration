  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row justify-between ~gap-8/12 ~pb-[5.438rem]/40 bg-beige-20-to-transparent-40 lg:bg-none  mx-auto">
        ...
        <AnimateOnView element="div" className="flex flex-col gap-8">
          ...
          <div className="flex gap-4">
            <Button
              role="primary"
              action={{
                href: "https://app.hydration.net/liquidity/all-pools",
                target: "_blank",
              }}
            >
              Provide Liquidity
      ...
      <AnimateOnView
        element="div"
        threshold={0.6}
        className="relative lg:w-[50%] min-h-[250px] w-[] container mx-auto flex justify-center items-center"
      >
        <motion.div
          className="absolute left-[-3rem] lg:left-[0rem] lg:top-[11rem] z-[5] w-[6.299rem] lg:w-[13.506rem] h-[10.919rem] lg:h-[23.409rem]"
          style={{
            offsetPath: `path(
        ...
        <motion.div
          className="absolute top-[2rem]  w-[10.699rem] lg:w-[22.938rem] h-[10.699rem] lg:h-[22.938rem] left-[25%] z-[4]"
          initial={{ opacity: 0, y: 0, rotate: 0, scale: 0.4 }}
          animate={controls}
        >
        ...
        <motion.div
          className="absolute left-[-10%] lg:left-[9rem] -top-[40%] lg:top-[-6rem] z-[5] w-[6.5rem] lg:w-[13.938rem] h-[11.369rem] lg:h[24.375rem] "
          style={{
            offsetPath: `path(
